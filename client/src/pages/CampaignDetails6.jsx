    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        ...
        <div className="flex md:w-[150px] w-full flex-wrap justify-between gap-[30px]">
          <CountBox title="Days Left" value="25" />
          <CountBox title="Raised of 5 ETH" value="2.1 ETH" />
          <CountBox title="Total Backers" value="8" />
        </div>
      </div>
          ...
          <div>
            <h4 className="font-epilogue font-semibold text-[18px] text-white uppercase">Story</h4>
              ...
              <div className="mt-[20px]">
                <p className="font-epilogue font-normal text-[16px] text-[#808191] leading-[26px] text-justify">Advanced medical research fund dedicated to developing breakthrough healthcare solutions. Our team is working on innovative treatments, diagnostic tools, and medical technologies that will improve patient outcomes and save lives worldwide.</p>
              </div>
          </div>
              ...
              <div className="mt-[20px] flex flex-col gap-4">
                {/* {donators.length > 0 ? donators.map((item, index) => ( */}
                  <div  className="flex justify-between items-center gap-4">
                    <p className="font-epilogue font-normal text-[16px] text-[#b2b3bd] leading-[26px] break-all">1. 0.8 ETH</p>
                    <p className="font-epilogue font-normal text-[16px] text-[#808191] leading-[26px] break-all">0x9876...5432</p>
                  </div>
                {/* )) : ( */}
